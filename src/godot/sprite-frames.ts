...
import type { ImgArchive, ImgFrame } from '../img/types.js';
 ...
 */
export function generateSpriteFramesTres(spriteFrames: SpriteFramesData): string {
    const lines: string[] = [];

    // 头部
    lines.push('[gd_resource type="SpriteFrames" format=3 uid="uid://placeholder"]');
    lines.push('');
